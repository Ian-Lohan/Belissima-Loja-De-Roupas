...
* Gerenciamento de Usuários (acesso exclusivo ao Administrador)
...
## Setup
Para usar o aplicativo você precisa seguir os passos:

#### 1. Requerimentos
  - Um Computador com Windows 7/8/10/11
  - Uma distribuição XAMPP instalada com Apache e MySQL ou o MySQL Workbench
  - JavaSE-1.8 ou mais atualizado
  - O banco de dados MySQL

#### 2. Suba o Banco de Dados
Utilize o arquivo belissima.sql para importar o banco de dados.
